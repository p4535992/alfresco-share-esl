/**
 * EnhancedSecurityRibbonMessages component.
 * 
 * Component provides a list of messages to be displayed in the label chooser
 * ribbon
 * 
 * @namespace Alfresco
 * @class EnhancedSecurityRibbonMessages
 */
(function()
{
    /**

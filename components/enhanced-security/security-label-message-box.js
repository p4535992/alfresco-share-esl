/**
 * EnhancedSecurityMessageBox component.
 * 
 * A message box to render errors and warnings about the user's currently
 * selected label as they enter it
 * 
 * @namespace Alfresco
 * @class Alfresco.EnhancedSecurityMessageBox
 */

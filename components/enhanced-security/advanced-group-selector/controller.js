/**
 * EnhancedSecuritySelectorAdvancedController component.
 * 
 * This component contains convenience methods to create Single Group Selectors
 * and Text Box Group Selector as well as methods to register existing
 * selectors. It includes callbacks to manage the communications between all
 * registered group selectors
 * 
 * @namespace Alfresco
 * @class EnhancedSecuritySelectorAdvancedController
 */
